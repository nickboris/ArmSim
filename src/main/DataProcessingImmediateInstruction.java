...
public class DataProcessingImmediateInstruction extends Instruction{
 public DataProcessingImmediateInstruction(){
  ...
  step.add("Step 5: Next, the value stored in the immediate field of the instruction is passed to the 'Extend' module to be zero-extended.");
  ArrayList<String> step5 = new ArrayList<>();
  step5.add("Imm");

  step.add("Step 6: The RD1 and ExtImm data lines are passed to the ALU to be computed (the Control Unit determines the type of operation requested by the instruction and passes the appropriate signal via the ALUControl data line).");
